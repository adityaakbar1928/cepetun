            ...
            <div class="container">
                <div class="grid lg:grid-cols-2 items-center">
                    <div>
                        ...
                        <p class="text-slate-400">Create your account now!</p>
                    </div>
                    <div class="flex flex-wrap items-center justify-start lg:justify-end gap-7 mt-5 lg:mt-0">
                        <button class="flex items-center">
                            <a href="#" class="bg-primary text-white rounded-full hover:shadow-lg hover:shadow-primary/30 focus:shadow-none focus:outline focus:outline-primary/40 transition-all duration-500 py-2 px-4">Register Here <span aria-hidden="true">&rarr;</span></a>
                        </button>
        ...
        <div class="container">
            ...
            <div class="grid lg:grid-cols-2 grid-cols-1 gap-14 py-6">
                <div>
                    ...
                    <p class="text-gray-500/80 mt-5 w-4/5">Penyedia Jasa Tunneling Termurah</p>
                </div>
                    ...
                    <div class="flex flex-col sm:flex-row gap-14 flex-wrap sm:flex-nowrap justify-between">
                        ...
                        <div>
                            <div class="flex flex-col gap-3">
                                <h5 class="mb-3 uppercase">Our Services</h5>
                                <div class="text-gray-500/80"><a href="javascript:void(0);">Tunneling for Game</a></div>
                                <div class="text-gray-500/80"><a href="javascript:void(0);">Tunneling for Monitoring</a></div>
                                <div class="text-gray-500/80"><a href="javascript:void(0);">Tunneling for Remote Access</a></div>
                                <div class="text-gray-500/80"><a href="javascript:void(0);">Tunneling for Everything</a></div>
                            </div>
                        </div>
            ...
            <div class="grid sm:grid-cols-2 text-center sm:text-start gap-6 py-5">
                <div>
                    <p class=" text-sm text-slate-500">
                        <script>document.write(new Date().getFullYear())</script>© CepeTun. All rights reserved.
                    </p>
                </div>
